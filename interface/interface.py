...
from interface.frame_forces import Frame_forces
from interface.frame_illustrations import Frame_illustrations
from interface.frame_resultants import Frame_resultants
import index
from models.forcePy import ForcePy
from enums.param_given import Param_given as pg

class InterfaceApp(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Calcule Forças de Reções nos apoios")
        ...
        for force in force_data:
            ...
            if force[0] == 'F':
                if force_data[force]['param_given'] == 'Fx e Fy':
                    ...
                    force_data[force]['param_given'] = pg.DECOMPOSED_FORCES
                    ...
                    force_data[force]['param1'] = float(force_data[force]['param1'])
                    force_data[force]['param_given'] = pg.MODULE_NVECTOR
